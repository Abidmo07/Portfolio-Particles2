...
export default function About() {
    return (
        <div className='bg-gray-800 w-full py-10'>
            ...
            <div className='w-full flex items-center px-6 mt-10 gap-5'>
                <div className='w-1/2'>
                ...
                <div className=' bg-gray-950  w-1/2 border-2 p-10 border-blue-500 rounded-lg shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#33CCCC,0_0_15px_#33CCCC,0_0_30px_#33CCCC]  shadow-blue-500 space-y-6'>

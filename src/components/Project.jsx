  ...
  const projects = [
    {
      ...
      name: "BorzChatt",
      description:
        "A real-time chat app using Supabase with typing indicators, active status, and group chat support.",
    ...
    },
    {
      ...
      name: "Movie App",
      description:
        "A movie browser with search, trailers, and ratings using the IMDB API.",
    ...
    },
    {
      ...
      description:
        "Cash-on-delivery online store with delivery pricing by wilaya and a simple order system.",
    ...
    },
    {
      ...
      description:
        "A personal portfolio site with animated transitions and project showcase.",
    ...
    },
    {
      ...
      name: "Borz AI",
      description:
        "A full-stack web app that simulate chatgpt in text generation using deepseek model through OpenRouterAPI",
    ...
    },
    {
      ...
      description:
        "A crypto tracker app with favorites management using Next.js, Zustand, and TypeScript",
      techUsed: ["Nextjs", "Coingecko API"],
